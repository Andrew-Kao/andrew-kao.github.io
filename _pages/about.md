...
### Working papers
- ["AI-tocracy"](https://andrew-kao.github.io/files/aitocracy_20221025.pdf) with Martin Beraja, David Yang, and Noam Yuchtman  (October 2022) — _Conditionally accepted at the Quarterly Journal of Economics_  <code>&nbsp;</code><a href="#!" class="btn" onclick="show_aitocracy()">Abstract</a>
...
- "Exporting the Surveillance State via Trade in AI" with Martin Beraja, David Yang, and Noam Yuchtman  <code>&nbsp;</code><a href="#!" class="btn" onclick="show_exportai()">Abstract</a>
